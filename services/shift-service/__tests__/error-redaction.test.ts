/**
 * Regression suite — shift-service routes through the SHARED Fastify error
...
describe('shift-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
