/**
 * Regression suite — chat-service routes through the SHARED Fastify error
...
describe('chat-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
