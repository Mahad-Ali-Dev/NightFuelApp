/**
 * Regression suite — sleep-service routes through the SHARED Fastify error
...
describe('sleep-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
