...
-- CreateIndex
CREATE INDEX "daily_progress_user_id_date_idx" ON "daily_progress"("user_id", "date" DESC);
...
-- CreateIndex
CREATE INDEX "body_metrics_user_id_recorded_at_idx" ON "body_metrics"("user_id", "recorded_at" DESC);

-- CreateIndex
CREATE INDEX "ai_usage_logs_user_id_created_at_idx" ON "ai_usage_logs"("user_id", "created_at" DESC);

-- CreateIndex
CREATE INDEX "hydration_logs_user_id_date_idx" ON "hydration_logs"("user_id", "date" DESC);

-- CreateIndex
CREATE INDEX "performance_reports_user_id_date_idx" ON "performance_reports"("user_id", "date" DESC);
