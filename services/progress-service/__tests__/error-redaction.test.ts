/**
 * Regression suite — progress-service routes through the SHARED Fastify error
...
describe('progress-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
