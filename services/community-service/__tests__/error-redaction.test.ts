/**
 * Regression suite — community-service routes through the SHARED Fastify error
...
describe('community-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
