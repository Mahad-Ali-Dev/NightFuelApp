/**
 * Regression suite — plan-service routes through the SHARED Fastify error
...
describe('plan-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
