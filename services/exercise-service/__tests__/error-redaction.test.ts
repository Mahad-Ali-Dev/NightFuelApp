/**
 * Regression suite — exercise-service routes through the SHARED Fastify error
...
describe('exercise-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
