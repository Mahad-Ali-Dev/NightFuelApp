/**
 * Regression suite — auth-service routes through the SHARED Fastify error
...
describe('auth-service shared error handler — 500 leak redaction (registerFastifyErrorHandler)', () => {
