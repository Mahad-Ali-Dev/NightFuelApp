...
export function MealLogCard({ name, time, calories, protein, carbs, fat, mealType = 'Meal', onPress }: MealLogCardProps) {
    return (
        <TouchableOpacity activeOpacity={0.8} onPress={onPress}>
            <Card style={styles.card}>
                ...
                <View style={styles.macrosRow}>
                    <View style={styles.macroPill}><Text style={[styles.macroText, { color: '#FF6B35' }]}>P {protein}g</Text></View>
...
const styles = StyleSheet.create({
    ...
    iconBg: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#FF6B3515', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    info: { flex: 1 },
    ...
    macroPill: { backgroundColor: '#0D1117', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 4 },
