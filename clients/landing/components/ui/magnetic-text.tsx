...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-[var(--color-lime)] overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <span className="text-5xl font-bold tracking-tighter text-[var(--color-ink)] whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
